...
/**
 * Pestaña "Herramientas" de la pantalla "Configuración". Dos tarjetas:
 * importar desde Rank Math (delega en Cmdroom_Rankmath_Importer) y vista
 * previa de metas/schema para una URL cualquiera del sitio.
 *
